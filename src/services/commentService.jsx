...
const getCommentsOfPostFromServer = (postId) => axios.get(`/api/comments/${postId}`)

const addCommentsToPostInServer = (postId,commentData,authorization) => 
...
export {getCommentsOfPostFromServer,addCommentsToPostInServer,editCommentInServer,deleteCommentFromServer}